...
def streaming_train(
    ...
    query_answers = make_cos_query_psuedo_answers(model, queries, docs, clusters)
    # print(f"query_answers:{type(query_answers)}")
