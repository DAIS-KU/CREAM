...
def train(dataset, start_domain):
    method = f"base_model_{dataset}_{start_domain}"
    ...
    for domain in domains:
        ...
        new_method = f"base_model_{dataset}_{start_domain}_{domain}"
        new_model_path = f"../data/domain_dependency/{new_method}.pth"
        torch.save(model.state_dict(), new_model_path)
        evaluate_term(dataset, domains, new_model_path, new_method)
