...
def train(
    ...
    total_loss_values = []
    loss_values_path = "../data/loss/total_loss_values_proposal_top1.txt"
    required_doc_size = (
    ...
    for session_number in range(start_session_number, end_sesison_number):
        ...
        if session_number != 0:
            ...
            model_path = (
                f"../data/model/proposal_top1_session_pre_{session_number-1}.pth"
            )
        else:
        ...
        model.train()
        new_model_path = f"../data/model/proposal_top1_session_pre_{session_number}.pth"
...
def evaluate_with_cluster(
    ...
    rankings_path = (
        f"../data/rankings/proposal_top1_session_pre_{session_number}_with_cluster.txt"
    )
    write_file(rankings_path, result)
    eval_log_path = (
        f"../data/evals/proposal_top1_session_pre_{session_number}_with_cluster.txt"
    )
...
def evaluate(session_number, model_path):
    ...
    rankings_path = f"../data/rankings/proposal_top1_session_pre_{session_number}.txt"
    write_file(rankings_path, result)
    eval_log_path = f"../data/evals/proposal_top1_session_pre_{session_number}.txt"
    evaluate_dataset(eval_query_path, rankings_path, eval_doc_count, eval_log_path)
...
def eval_rankings(session_number):
    ...
    rankings_path = f"../data/rankings/proposal_top1_{session_number}_with_cluster.txt"
